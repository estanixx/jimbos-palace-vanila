...
$query = "INSERT INTO transaccion(codigo, nombre_cliente, codigo_empleado, monto_dinero, fecha, hora, tipo, cantidad_fichas, nombre_torneo) 
          VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)";

$params = array($codigo, $nombre_cliente, $codigo_empleado, $monto_dinero, $fecha, $hora, $tipo, $cantidad_fichas, $nombre_torneo);
